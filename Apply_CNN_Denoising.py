...
dir1 = "D:/data/DWI_denoising/ABCD/B10/SoS"
sigLength = 206     # length of DWI signal
...
def main():
    ...
    tmp = nib.load(op.join(dir1,'nodif_brain_mask.nii.gz'))
    ...
    # High-noise data
    tmp = nib.load(op.join(dir1,'eddy_corrected_data.nii.gz'))
    ...
    saver.restore(sess, "./training_B7/ckpt_bs6000lr0005/model_bs6000lr0005.ckpt") # used to load a trained model in testing
    ...
    nib.save(x1, op.join(dir1,'Denoised2.nii.gz'))
